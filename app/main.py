...
def start_agent_session(session_id, is_audio=False):
    ...
    if is_audio:
        config["input_audio_transcription"] = {}  # Enable transcription of user's audio input
        config["output_audio_transcription"] = {}  # Enable transcription of agent's audio output
